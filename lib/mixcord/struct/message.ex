defmodule Mixcord.Struct.Message do
  ...
  * `:author` - *Struct*. A `Mixcord.Struct.User` struct.
  ...
  * `:mentions` - *List*. A list of `Mixcord.Struct.User` structs mentioned in the message.
  * `:mention_roles` - *List*. A list of `Mixcord.Struct.Role` structs mentioned in this message.
