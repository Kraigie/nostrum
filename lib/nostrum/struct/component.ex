defmodule Nostrum.Struct.Component do
  ...
  A ink button can be created using `Nostrum.Struct.Component.Button.create_link_button/2`
  ...
  An interaction button can be created using `Nostrum.Struct.Component.Button.create_interaction_button/3`
  ...
  ### Select Menu Option
  A select Menu with no options would not be very useful.
